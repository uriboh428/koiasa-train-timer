...
**最新バージョン: Ver 3.8 (朝日＆ひまわり・欧州サンシャインデザイン版)**
...
* **Ver 3.8 (最新版)**: 欧州サンシャインデザイン版（Aube Solaire & Tournesol）。欧州の最先端ウォームモダン・ミニマリズムを取り入れ、奥様がお好きなオレンジ色を軸に「朝日」と「ひまわり」をモチーフとした爽やかなデザインシステムへ全面刷新。温かみのあるエクリュ背景、夜明けのテラコッタ・グラデーションカード、ひまわりゴールドのアクセントによって、毎朝の通勤・移動を心地よく照らすデザインを実現。
