...
flowchart TD
    ...
    V5["【Phase 5: モバイル＆運用完成】<br>Ver 3.1〜3.2 (現在)<br>・Streamlit制約両立(noindex保護)<br>・ワンタップURL即時再発行/失効<br>・スマホ特化UI(48px/2.85rem特大時計)"]
