...
flowchart TD
    ...
    V9["【Phase 9: 完全ロール分離＆ゼロトラスト】<br>Ver 3.6 (最新)<br>・初期一般モード起動の完全統一<br>・日常設定欄からの管理操作完全撤去<br>・画面最下部オンデマンド認証<br>・キャッシュ無効化配信"]
